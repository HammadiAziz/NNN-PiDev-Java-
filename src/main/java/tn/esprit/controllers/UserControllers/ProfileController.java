...
public class ProfileController {
    ...
    void NavigateToUpdate(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/upadateGUI.fxml"));
    ...
    void NavToHome(ActionEvent event) {
        try {
            // Load the AfficherProduits.fxml file
            ...
            produitStage.setScene(scene);
            produitStage.setTitle("Shop");

            // Show the AfficherProduits stage
            produitStage.show();
