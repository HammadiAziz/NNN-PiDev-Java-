...
public class LivraisonService implements IService<Livraison> {
    ...
    public List<Livraison> getAllLivraisonsByUserId(int userId) {
        List<Livraison> livraisons = new ArrayList<>();
        String selectReq = "SELECT * FROM `livraison` WHERE user_id = ?";
        ...
        try {
            ...
            while (rs.next()) {
                Livraison livraison = new Livraison();
                livraison.setNomC(rs.getString("NomC"));
                livraison.setPrenomC(rs.getString("prenomC"));
                livraison.setEmail(rs.getString("email"));
                livraison.setAdress(rs.getString("adresse"));
                livraison.setPaiementType(rs.getString("typePaiement"));
                livraison.setState(rs.getString("state"));
                livraison.setId(rs.getInt("id"));
                livraison.setPhoneNumber(rs.getLong("phoneN"));
                livraison.setArchived(rs.getBoolean("archived"));
                livraison.setId_suivi(rs.getInt("id_suivi"));
                livraison.setUser_id(rs.getInt("user_id"));
