package esprit.nnn.Controllers.Quiz.Front.Certification;

import esprit.nnn.Models.Certification;
import esprit.nnn.Models.HistoryQuiz;
import esprit.nnn.Services.CertificationService;
import esprit.nnn.Services.QuizService;
import esprit.nnn.Services.historyService;
...
this.quizname = quizname;
    if (score>quest/2) {
        ...
        se.Create(new Certification (quizid,id));
        hs.Create(new HistoryQuiz(quizid,1,1 ));
