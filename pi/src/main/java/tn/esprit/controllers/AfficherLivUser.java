...
public class AfficherLivUser {
    ...
    void ajouterLiv(ActionEvent event) {
        try {
            System.out.println("Resource URL: " + getClass().getResource("/FXML/User/AjouterLiv.fxml"));
            Parent root = FXMLLoader.load(getClass().getResource("/FXML/User/AjouterLiv.fxml"));
    ...
    public void UpdateLiv(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/Admin/ModifierLiv.fxml"));
    ...
    void ArchiverLiv(ActionEvent event) {
        ...
        treeview.getItems().remove(selectedID);
    }
    @FXML
    void Suivi(ActionEvent event) {
        try {
            // Utilisez FXMLLoader pour charger le fichier FXML de la nouvelle page
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/User/Map.fxml"));
            Parent root = loader.load();
